...
<head>
	...
	<title>BPL Store | Paypal Checkout</title>
											...
											<h1 class="text" ; align='right'>
												...
												<script>
													...
													paypal.Button.render({
														...
														env: 'sandbox',
														client: {
															sandbox: 'ARvqcmcSBgkeXQ4Mdtfoejg4UGLDA0G7B-C_KkROsm2Ajxb0jAWXmbD-oox9v-i6Xeb04lKihxgC-m3Y',
														...
														payment: function(data, actions) {
															return actions.payment.create({
																transactions: [{
																	...
																	description: 'You are shopping at BPL Store.',
